...
echo "🔧 Fixing JWT User ID Mapping Issue..."
...
# 2. Fix profileController.js to handle userId instead of id
echo "[INFO] Fixing profileController.js to handle userId mapping..."
...
const getProfile = async (req, res) => {
  try {
    // Check if user ID exists and is valid - handle both 'id' and 'userId'
...
# 3. Fix settingsController.js to handle userId as well
echo "[INFO] Fixing settingsController.js to handle userId mapping..."
...
# 6. Test profile and settings endpoints
...
echo "[INFO] JWT user ID mapping fix complete!"
