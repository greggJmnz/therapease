...
export const adminAPI = {
  ...
  approvePendingTherapist: (therapistId) => api.post(`/admin/therapists/${therapistId}/approve`),
  rejectPendingTherapist: (therapistId) => api.post(`/admin/therapists/${therapistId}/reject`),
