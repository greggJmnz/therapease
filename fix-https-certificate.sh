...
echo "🔒 Fixing HTTPS Certificate Configuration..."

# Check existing certificates
echo "📋 Checking existing certificates..."
sudo certbot certificates

# Check if certificate exists for therapease.site
if [ -f "/etc/letsencrypt/live/therapease.site/fullchain.pem" ]; then
    echo "✅ SSL certificate already exists for therapease.site"
...
EOF
    ...
    echo "❌ No SSL certificate found for therapease.site"
    echo "🔐 Attempting to generate new certificate..."
    ...
    if [ -f "/etc/letsencrypt/live/therapease.site/fullchain.pem" ]; then
        ...
        echo "🔄 Please run this script again to configure Nginx"
    else
