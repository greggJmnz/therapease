...
echo "🔧 Fixing Database Schema Issues - Final Fix..."
...
echo "[INFO] Checking current database schema..."

# Check appointments table structure
echo "[INFO] Checking appointments table structure:"
...
# 3. Fix appointments table schema
...
ADD COLUMN IF NOT EXISTS appointmentTime TIME DEFAULT '09:00:00',
...
# 4. Fix adminController.js SQL parameter binding issue
echo "[INFO] Fixing adminController.js SQL parameter binding..."

# Create a backup
cp controllers/adminController.js controllers/adminController.js.backup

# Fix the getAllUsers function to handle parameters correctly
...
const getAllUsers = async (req, res) => {
  try {
    ...
    // Fix: Use proper parameter binding for LIMIT and OFFSET
...
echo "[INFO] Database schema fix complete!"
